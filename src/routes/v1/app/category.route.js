...
router.post('/:categoryId/favorite', auth(), validate(categoryValidation.favorite), categoryController.addFavoriteCategory);
router.delete('/:categoryId/favorite', auth(), validate(categoryValidation.favorite), categoryController.removeFavoriteCategory);
