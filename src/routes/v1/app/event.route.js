...
router.patch('/',auth(), validate(eventValidation.notify), eventController.notifyEvent);
router.post('/add',auth(), validate(eventValidation.create), eventController.createEvent);
router.put('/',auth(), validate(eventValidation.edit), eventController.editEvent);
