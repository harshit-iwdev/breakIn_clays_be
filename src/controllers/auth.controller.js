...
const appleCallback = catchAsync(async (req, res) => {
  ...
  // Optionally: Verify the ID token (JWT)
  const decodedToken = jwt.decode(id_token, { complete: true });
  console.log("User Info from ID Token", decodedToken);

  // You can now use this data to create a user session / JWT for your app
  // Then redirect or respond with your app token
  //res.send({ success: true, token: id_token });
